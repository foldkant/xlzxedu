	...
	if($conn){
		...
		$countSql = "SELECT COUNT(*) FROM `lesson` WHERE `course_id`= $courseId ORDER BY `id` DESC";
		...
		$sql = "SELECT * FROM `lesson` WHERE `course_id`= $courseId ORDER BY `id` DESC LIMIT $startpos,$pageNum";
		 // echo($sql);
