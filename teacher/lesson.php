                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        <div class="layui-btn-container">
                            <a href="edit-lesson.php?lessonId=<?php echo $lessonId?>">
                                <button class="layui-btn layui-btn-fluid">编辑课时</button>
                            </a>
                            <a href="edit-lesson-resource.php?lessonId=<?php echo $lessonId?>">
                                <button class="layui-btn layui-btn-fluid">课时资源管理</button>
                            </a>
                            <button class="layui-btn layui-btn-normal layui-btn-fluid" id="fenceng">更新学生分层信息</button>
                            <a href="task.php?lessonId=<?php echo $lessonId?>">
                                <button class="layui-btn layui-btn-normal layui-btn-fluid">考勤管理</button>
                            </a>
                            <a href="class.php#class=student-file">
                                <button class="layui-btn layui-btn-danger layui-btn-fluid">课堂活动</button>
                            </a>
                            <a href="task.php?lessonId=<?php echo $lessonId?>">
                                <button class="layui-btn layui-btn-warm layui-btn-fluid">任务管理</button>
                            </a>
                        </div>
                    </div>
                </div>
