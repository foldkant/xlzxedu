...
<body>
                ...
                <form class="layui-form" action="../">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="password" id="password" name="password" required lay-verify="password" placeholder="请输入新的密码" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="subject" required lay-verify="required">
    ...
    <script src="../static/js/teacher/first-login.js"></script>
</body>
